...
peut exporté sont des nombres, des chaînes de caractères des
structure composite, des procédures et des fonctions.
L'ensemble de ces données constitue les fonctionnalités de la
bibliothèque de code. Les fonctionnalités d'une bibliothèque peut être copié dans l'exécutable
...
commence par la bibliothèque passé à \textit{dlsym} suivit de ses dépendances. Les résolution de fonctionnalité
provenant d'appels indirecte au \textit{dynamic linker} inclut le programme principal et ses dépendances avant
la bibliothèque passé à \textit{dlsym}.

\begin{center}
    \begin{figure}[ht]
        \includegraphics{figures/libdeps-ex1.pdf}
        \caption{Exemple de dépendance dans un application simple fictive.
            Les ellipses sont les fonctionnalités exportées par les bibliothèques}
    \end{figure}

\end{center}

% TODO: exemple de résolution indirect
