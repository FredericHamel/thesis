...
Les formes spéciales de base en Scheme sont \lstcode{define}, \lstcode{lambda},
...
résultat.  Certaines procédures, telles que \lstcode{for-each}, \lstcode{map} et
\lstcode{fold}, bénéficient que les procédures soient des objets de première classe.
