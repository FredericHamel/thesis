...
Erlang, nous est apparu comme une option intéressante vu sa
performance, sa portabilité et son support pour la méta programmation
facilité par son homoiconicité.  Notre travail a donc pu se concentrer
...
\section{Conclusion}
%
Les révisions de Scheme qui offre les fonctionnalités requises sont R6RS et
R7RS.  Elles permettent tous les deux, la modularisation du code et la création
module avec des noms uniques, ce qui est requis pour le bon fonctionnement du
...
entre les implémentations de Scheme aussi compatible avec R7RS.
