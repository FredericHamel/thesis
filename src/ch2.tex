...
syntaxe \lstcode{library}. Cette syntaxe associe les définition dans le module
...
module R6RS est séparé en 4 parties: le nom, une sous forme \lstcode{export}, une
sous forme \lstcode{import} et le corps du module. Le nom du module peut contenir
un numéro de version. La sous forme \lstcode{export} spécifie la liste des
associations définit ou importé dans le module. La sous forme \lstcode{import}
