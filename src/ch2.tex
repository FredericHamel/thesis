...
Le langage n'offre pas de syntaxe spécial pour les boucle; il offre une forme
de récursion sans coût mémoire, c'est la récursion en position terminal. Les
procédures utilisent la récursion pour effectué les boucle.
...
Plusieurs langages offre des constructions pour transformer le code.  Ces
constructions sont les macros. Ils sont utilisés pour ajouter des raccourcis de
programmation dans le langage.   En C et C++, les macros sont non récursives et
limités au remplacement textuel simple. Un appel à la macro est remplacer par
le corps de celle-ci. En Scheme, les macros ont toute la puissance des
procédures. La différence est le mode de passage de paramètre durant
l'application de la macro. Les paramètres sont passés à la macro sans être
évalués, c'est ce qu'on appelle le passage par nom.
...
de Scheme offre la formee \lstcode{define-macro} qui est l'équivalent du
