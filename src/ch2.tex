...
Les formes syntaxique spéciales de base en Scheme sont \lstcode{define}, \lstcode{lambda},
...
résultat.  Certaines procédures, commme \lstcode{for-each}, \lstcode{map} et
...
syntaxiquement en partant de R4RS à R7RS. La forme \lstcode{define-library}
