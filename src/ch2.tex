...
Chaque spécification d'import \lstcode{<import spec>} peut être soit une simple importation
ou un importation avec un niveau. Le niveau d'importation est soit:
\begin{center}
  \begin{mplisting}{0.9}
run
expand
...
\lstcode{expand}. L'importation d'un module contient les sous formes suivantes:
\begin{center}
\begin{mplisting}{0.7}
  <libref>
  (library <libref>)
...
La syntaxe pour l'importation est décrit dans la
