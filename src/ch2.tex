...
Ce chapitre traite l'évolution des modules du langage Scheme qui a
servi dans implantation du système de module. La structure
des modules de chaque révision est présentée (R4RS, R5RS, R6RS et R7RS).
Le tout, pour introduire la syntaxe des modules utilisée dans le
système de module implémenté dans ce mémoire.
