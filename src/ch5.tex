...
\textit{semantic versioning}\cite{SemanticVersioning} qui est une façon d'organiser les versions. Les
...
échouerait quand ils ne sont pas dans la cache locale du dépôt.
