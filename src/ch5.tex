...
façon optionnelle le préfixe d'installation.  Elle retourne la valeur de vérité
...
L'installation des \textit{package} peut être effectuée en invoquant
...
local, s'il termine soit par un \texttt{/} ou par un point.
\begin{center}
  \begin{mplisting}{0.8}
...
montrent les différentes façons d'installer d'un \textit{package} en invoquant de
l'interprète Gambit.
