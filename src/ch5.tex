...
\lstcode{_git} qui offre un interface à l'utilitaire \lstcode{git}. Le
...
La compilation d'un module est fait en passant le nom du module en paramètre.

%% Module avec du C.

La compilation d'un module se fait par le \texttt{\textit{<module-ref>}}.
Le compilateur cherche le module dans les répertoires du
\lstcode{##module-search-order}. Le module est compilé s'il est
trouvé dans un sous-répertoire du module. La compilation du module
\texttt{srfi/69} se fait par la commande suivante:
