...
\end{mplisting}
  \caption{Écriture d'un module qui implémente une pile. Ce module est
           séparé en 2 fichiers. Le fichier \texttt{stk\#.scm} contient les
           exportations et \texttt{stk.scm} contient l'implémentation des
           fonctions.}
...
La figure~\ref{fig:relative-import} est un exemple d'importation relatif.
