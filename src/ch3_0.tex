...
d'exécution du programme. Puisque ce système de module utilise des
bibliothèques dynamiques du système d'exploitation, il est donc nécessaire de
déterminer la nature de ces situations problématiques. Nous avons procédé à des
expériences pour déterminer sous quelles conditions des bibliothèques
...
bibliothèques dynamiques. Les expériences effectuées pour déterminer
...
souris). Ces conflits présents dans les bibliothèques dynamiques
du système d'exploitation peuvent être propagés par la FFI du langage
de programmation.

Nous avons déterminé que l'utilisation de variables globales peut entraîner
des problèmes de concurrence entre des bibliothèques. Ils apparaissent dans
