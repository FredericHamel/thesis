...
est important.  Le chapitre \ref{XXX} va détailler plus en profondeur
ces problèmes.
...
\ref{XXX} explique plus en profondeur le fonctionnement de éditeur de liens
...
chapitre \ref{bibliotheque}.

Dans un contexte distribué, le programme principal peut être amené à exécuter
du code d'un module absent localement. Cela nécessite un téléchargement du
module et possiblement une compilation. Une fois le module installé, il faut le
