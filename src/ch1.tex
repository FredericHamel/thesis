...
lier les fonctionnalités des modules au programme principal. Le chapitre % chapter or section
...
Les appels RPC sont présents dans beaucoup de systèmes et langages de
...
service demandé soit déjà en place sur la machine distante.
...
Scheme~\cite{Sumii00animplementation}\cite{TermiteScheme},
...
Le chapitre 2 explique les approches existantes de modularisation en Scheme.
Le chapitre 3 explique les problématiques des dépendances entre des modules
natifs au sein du système de module. Le chapitre 4 traite de l'implémentation
des modules dans Gambit. Le chapitre 5 explique les méchanisme de chargement
des modules implémentés.

-------------------------

Le chapitre 6 traite
du transfert des modules et de la migration de tâche.

Le chapitre 7 est une évaluation du système de modules avec des
résultats d'expérience effectuée entre des SE et architectures
différentes.
